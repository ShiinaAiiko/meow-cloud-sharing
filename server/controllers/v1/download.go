...
func (fc *DownloadController) GetDownloadUrls(c *gin.Context) {
	// 1、请求体
	var res response.ResponseProtobufType
	res.Code = 200

	log.Info("GetDownloadUrls")
	// 2、获取参数
	data := new(protos.GetDownloadUrls_Request)
	var err error
	...
	protoData := &protos.GetDownloadUrls_Response{}
